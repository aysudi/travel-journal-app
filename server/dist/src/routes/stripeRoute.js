...
stripeRouter.post("/create-checkout-session", async (req, res) => {
    try {
        const { lineItems, mode = "subscription", successUrl, cancelUrl, customer, metadata, customText, subscriptionData, } = req.body;
        ...
        const sessionParams = {
            ...
            custom_text: {
                submit: {
                    message: "Welcome to VoyageVault Premium! Start your premium journey today.",
                },
            },
            locale: "auto",
        };
        ...
        if (customText)
            sessionParams.custom_text = customText;
        if (subscriptionData)
